...
export default function GameDriveDashboard() {
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <VersionManager isOpen={showVersionManager} onClose={() => setShowVersionManager(false)} currentSales={filteredSales} platforms={platforms} onActivateVersion={handleActivateVersion} activeVersionId={activeVersionId} productId={filterProductId || null} productName={products.find(p => p.id === filterProductId)?.name || null} clientId={filterClientId || null} clientName={clients.find(c => c.id === filterClientId)?.name || null} hasUnsavedChanges={versionSnapshotModified} onSaveVersion={handleSaveVersionSnapshot} />
