      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        <div className={styles.container}>
          ...
          <div className={styles.nav}>
            <Link href="/coverage/feed" className={styles.navLink}>Feed</Link>
            <Link href="/coverage/report" className={styles.navLink}>Full Report</Link>
            <span className={styles.navActive}>Campaign Report</span>
          </div>
