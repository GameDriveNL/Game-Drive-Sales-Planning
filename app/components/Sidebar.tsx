...
export function Sidebar() {
  ...
  const navItems: { name: string; href: string; icon: React.ReactNode; description: string; feature: FeatureKey }[] = [
    ...
    },
    {
      ...
      description: 'Launch revenue forecast'
    },
    {
    ...
    },
    {
      ...
      description: 'Steam tag optimizer'
    },
    {
      name: 'Banner Preview',
      href: '/banner-preview',
      ...
      description: 'Store banner mockups'
    },
    {
      name: 'Social Tools',
      href: '/social-tools',
      ...
      description: 'Trend watch, captions, Reddit finder'
    },
  ]
      ...
      <div className={collapsed ? styles.sidebarCollapsed : styles.sidebar}>
        ...
        <div className={collapsed ? styles.settingsSectionCollapsed : styles.settingsSection}>
          {collapsed ? (
            <Link
              href="/manual"
              className={isManualActive ? styles.navItemCollapsedActive : styles.navItemCollapsed}
              title="Manual"
            >
              <div className={styles.navIconCollapsed}>
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className={styles.tooltip}>Manual</span>
            </Link>
          ) : (
            <Link
              href="/manual"
              className={isManualActive ? styles.navItemActive : styles.navItem}
            >
              <div className={styles.navIcon}>
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              ...
              <div className={styles.navText}>
                <div className={styles.navLabel}>Manual</div>
                <div className={styles.navDescription}>How everything works</div>
              </div>
            </Link>
          )}
        </div>
